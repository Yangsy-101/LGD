...
const GATEWAY_CONFIG = {
    ...
    port: 10000,                  // 与 screen_server.py 默认端口一致
...
class MjpegReceiver {
    constructor(config) {
        ...
        this._canvasVisible = false;  // ★ 缓存可见性，避免每帧读 style.display 触发回流
...
// ============================================================
//
// 本文件由 forest-fire2.html 引入（相对路径 ../../../newjs/forest_fire.js）
// forest-fire2.html 中通过内联脚本将"开始检测"/"结束检测"按钮绑定到 MjpegReceiver。
//
// MjpegReceiver 只接管视频流接收，传感器图表、抽屉、警报等仍由 forest-fire.js 负责。
//
// 使用:
//   1. 确认 GATEWAY_CONFIG.host / port / streamPath 与网关一致
//   2. 浏览器打开 forest-fire2.html

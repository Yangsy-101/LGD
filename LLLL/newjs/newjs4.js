...
/**
 * 设备管控画面 — 网关配置（端口 10004）
 */
const DEVICE_CONFIG = {
    host: '192.168.0.233',
    port: 10004,
    streamPath: '/stream',
    canvasId: 'sbg-device-ws-frame',
    placeholderId: 'sbg-device-video-placeholder',
...
// ============================================================
//
// 本文件由 shebeiguanong2.html 引入（相对路径 ../../../newjs/newjs4.js）
// shebeiguanong2.html 中通过内联脚本控制视频。
//
// 使用:
//   DEVICE_CONFIG → 设备管控画面 (端口 10004)
//   浏览器打开 shebeiguanong2.html
//   点击"开始设备管控检测"开始接收
